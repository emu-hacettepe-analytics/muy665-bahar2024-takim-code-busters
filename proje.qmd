...
# Veri setini yC<kleme
veri <- read.csv(file = "nba_dataset.csv", head = TRUE, sep=";")
boy_veri <- veri[1:280,]

#veriyi TRB sC<tununa gC6re sD1ralama
rebounds_data <- veri[order(boy_veri$TRB, decreasing = TRUE),]

#TRB sC<tununa gC6re sD1ralanan veriden ilk 50sini alma
...
boy_veri |> ggplot()+ geom_point(aes(x = Height, y = TRB), size = 2)+ scale_x_continuous(limits = c(1.6, 2.3)) +scale_y_continuous(limits = c(25, 280))
