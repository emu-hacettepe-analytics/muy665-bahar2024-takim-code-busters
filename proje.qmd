...
#Veri görselleştirme
veri %>% dplyr::filter(MP >0) %>% ggplot() + geom_point(aes(x = Height, y = TRB), size = 2)+ scale_x_continuous(limits = c(1.6, 2.3)) +scale_y_continuous(limits = c(0, 15))

#veriyi sadeleştirme
veri %>% dplyr::filter(MP >25) %>% ggplot() + geom_point(aes(x = Height, y = TRB), size = 2)+ scale_x_continuous(limits = c(1.6, 2.3)) +scale_y_continuous(limits = c(0, 15))

#outliers grupları filtreleme
veri %>% dplyr::filter(MP >25  & TRB>5 & TRB< 7.5) %>% ggplot() + geom_point(aes(x = Age, y = TRB), size = 2)+ scale_x_continuous(limits = c(18, 50)) +scale_y_continuous(limits = c(0, 15))
